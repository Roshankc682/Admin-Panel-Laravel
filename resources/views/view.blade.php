...
@section('view_page_content')

<!-- success_delete -->


  @if(session()->has('success_delete'))  
              <div class="alert alert-danger alert-dismissible fade show" role="alert" style="width:50%;margin-left: 30%;">
   ...
   @if(session()->has('edit_success'))  
              <div class="alert alert-primary alert-dismissible fade show" role="alert" style="width:50%;margin-left: 30%;">
...
<center><h1 class="Available_book">Available Books</h1></center>
 ...
 <table class="table table-dark" style="width:99%;margin-left: 5px;">
  <thead>
    <tr>
      ...
      @foreach($print_function_book as $print_book)
